...
dashboardHtml = dashboardHtml.replace(
  runtimePattern,
  '<script src="./wip-runtime.bundle.js?v=20260911-branch-pages-v3&fix=reset-excel-filters-v1"></script>'
);
...
console.log('Materialized branch-compatible dashboard with resettable Excel header filters, local Ville filtering, route status removed, route panel capped to map height, pre-ranking SIRET dedupe and no commercial-potential Details section.');
