(() => {
  ...
  function isolateCityInput(original) {
    ...
    // Canton adaptatif a historiquement attaché un listener anonyme à f-ville
    // qui recalcule le référentiel à chaque caractère. Comme ce listener ne peut
    // pas être retiré avec removeEventListener, on remplace une seule fois le
    // champ par un clone identique : valeur, id, classes et attributs sont gardés,
    // mais les anciens listeners coûteux disparaissent.
